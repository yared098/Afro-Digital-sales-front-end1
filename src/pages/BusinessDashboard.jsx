...
import { FaBuilding, FaCog, FaSignOutAlt } from 'react-icons/fa'; // Import icons
...
const BusinessDashboard = () => {
  ...
  const menuItems = [
    { name: 'Business Overview', link: '/business-overview', icon: FaBuilding },
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 p-4">
        ...
        {/* Other content for the business dashboard */}
      </div>
    </div>
  );
};
